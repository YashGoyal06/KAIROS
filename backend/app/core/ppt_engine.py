...
class PPTEngine:
    ...
    def fit_text_to_frame(text_frame, text: str, max_font_size: int = 16, min_font_size: int = 9, is_title: bool = False):
        """
        STRICT ANTI-OVERFLOW ENGINE:
        Calculates character density and dynamically adjusts font size and line wrap
        without wiping out original run styling or colors.
        """
        ...
        # Preserve original font properties & alignment if available
        orig_color = None
        orig_name = None
        orig_bold = None
        orig_italic = None
    ...
    def fill_presentation(
        ...
        """
        Smart Content Ingestion Engine:
        Analyzes shapes by coordinates and text roles (title vs body vs branding footer),
        replaces 'Lorem Ipsum' and placeholders in-place, and preserves designer template layouts.
        """
        ...
        # Build clean bullet lists for section replacements
        ...
        # Standard slide section data pool
        slide_contents = [
            # Slide 1: Cover Title & Vision
            {
        ...
        # Footer branding patterns to protect/update intelligently
        ...
        for slide_idx, slide in enumerate(prs.slides):
            ...
            # Collect text shapes on slide
            text_shapes = [s for s in slide.shapes if s.has_text_frame]

            # Categorize text shapes into: Footer/Branding, Title, Body/LoremIpsum
            title_shapes = []
            body_shapes = []
            ...
            for shape in text_shapes:
                ...
                # Determine if shape is a slide title or card heading vs body content
            ...
            if title_shapes:
                ...
                # If secondary title shape exists (e.g. Subtitle)
            ...
            # 2. Update Body / Card Shapes
            if body_shapes:
                if len(body_shapes) == 1:
                    # Single main body textbox -> combine subtitle & bullets
                    ...
                    # Multi-card layout (e.g. 3 problem cards or 3 solution boxes)
